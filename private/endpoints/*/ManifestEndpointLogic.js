...
class ManifestEndpointLogic extends EndpointLogic {
  ...
  async execute() {
    ...
    Logging.debugMessage({
      severity: 'INFO',
      message: 'Executing manifest.json request',
      location: LOCATION,
    });
    ...
    if (!configuration.manifest) {
      Logging.debugMessage({
        severity: 'FINEST',
        message: `Manifest configuration is NOT defined`,
        location: LOCATION,
      });
      ...
      Logging.debugMessage({
        severity: 'INFO',
        message: 'Executed manifest.json request',
        location: LOCATION,
      });
      return;
    }
    Logging.debugMessage({
      severity: 'FINEST',
      message: `Manifest configuration is defined`,
      location: LOCATION,
    });
    ...
    if (configuration.manifest.name !== undefined) {
      Logging.debugMessage({
        severity: 'FINEST',
        message: `Manifest name is defined in configuration: ${configuration.manifest.name}`,
        location: LOCATION,
      });
    ...
    if (configuration.manifest.short_name !== undefined) {
      Logging.debugMessage({
        severity: 'FINEST',
        message: `Manifest short_name is defined in configuration: ${configuration.manifest.short_name}`,
        location: LOCATION,
      });
    ...
    if (configuration.manifest.description !== undefined) {
      Logging.debugMessage({
        severity: 'FINEST',
        message: `Manifest description is defined in configuration: ${configuration.manifest.description}`,
        location: LOCATION,
      });
    ...
    if (configuration.manifest.start_url !== undefined) {
      Logging.debugMessage({
        severity: 'FINEST',
        message: `Manifest start_url is defined in configuration: ${configuration.manifest.start_url}`,
        location: LOCATION,
      });
    ...
    if (configuration.manifest.display !== undefined) {
      Logging.debugMessage({
        severity: 'FINEST',
        message: `Manifest display is defined in configuration: ${configuration.manifest.display}`,
        location: LOCATION,
      });
    ...
    if (configuration.manifest.background_color !== undefined) {
      Logging.debugMessage({
        severity: 'FINEST',
        message: `Manifest background_color is defined in configuration: ${configuration.manifest.background_color}`,
        location: LOCATION,
      });
    ...
    if (configuration.manifest.theme_color !== undefined) {
      Logging.debugMessage({
        severity: 'FINEST',
        message: `Manifest theme_color is defined in configuration: ${configuration.manifest.theme_color}`,
        location: LOCATION,
      });
